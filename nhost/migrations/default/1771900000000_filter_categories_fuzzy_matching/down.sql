...
-- Drop the 11-param version (with filter_categories) before recreating the 10-param version
DROP FUNCTION IF EXISTS public.search_places_hybrid(TEXT, TEXT[], FLOAT8[], FLOAT8, FLOAT8, FLOAT8, FLOAT8, FLOAT8, INTEGER, UUID[], TEXT[]);
