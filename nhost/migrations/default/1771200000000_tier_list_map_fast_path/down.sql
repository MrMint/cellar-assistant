-- Revert tier list fast path: drop composite index and restore previous function

-- ============================================================
-- 1. Drop composite index
-- ============================================================
DROP INDEX IF EXISTS idx_tier_list_items_place_id_tier_list_id;

-- ============================================================
-- 2. Restore search_places_adaptive_cluster from 1771000000000
-- ============================================================
