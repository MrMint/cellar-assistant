-- ==========================================
-- Add Rating and Visit Status Filters to Clustering
-- ==========================================

-- Step 1: Drop existing function to replace with new signature
DROP FUNCTION IF EXISTS search_places_adaptive_cluster(FLOAT, FLOAT, FLOAT, FLOAT, TEXT[], INTEGER);

-- Step 2: Create enhanced function with additional filters
CREATE OR REPLACE FUNCTION search_places_adaptive_cluster(
  ...
  visit_status_filter TEXT DEFAULT NULL, -- 'visited', 'unvisited', or NULL for all
  user_id UUID DEFAULT NULL, -- Required for visit status filtering
