...
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER "set_public_liquors_updated_at"
BEFORE UPDATE ON "public"."liquors"
FOR EACH ROW
EXECUTE PROCEDURE "public"."set_current_timestamp_updated_at"();
COMMENT ON TRIGGER "set_public_liquors_updated_at" ON "public"."liquors"
