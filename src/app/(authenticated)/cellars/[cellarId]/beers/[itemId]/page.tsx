...
import { CellarBeerDetails } from "@/components/beer/CellarBeerDetails";
import { GetCellarBeerDetailsQuery } from "@/components/beer/fragments";
import { serverQuery } from "@/lib/urql/server";
import { getServerUserId } from "@/utilities/auth-server";
import { getCellarItemData } from "../../getCellarItemData";

export default async function CellarBeerDetailsPage({
  params,
}: {
  ...
  const data = await serverQuery(GetCellarBeerDetailsQuery, { itemId, userId });
